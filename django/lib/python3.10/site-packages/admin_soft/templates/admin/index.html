          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Found</p>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Undelivered</p>
                    <h5 class="font-weight-bolder mb-0">
                      {{ foundf }}
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Valuable</p>
                    <h5 class="font-weight-bolder mb-0">
                      4
                      <span class="text-success text-sm font-weight-bolder"></span>
                    </h5>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div>
                            <img src="{% static 'img/team-4.jpg' %}" class="avatar avatar-sm me-3" alt="xd">
                          </div>
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">{{ user.first_name }} {{ user.last_name }}
                              {% if user.first_name == '' %}
                              {{ user.username }}
                              {% endif %}</h6>
                          </div>
                        ...
                        <div class="progress-wrapper w-75 mx-auto">
                          <div class="progress-info">
                            <div class="progress-percentage">
                              <span class="text-xs font-weight-bold">{{ user.submission_count }}</span>
                            </div>
                          </div>
                          <div class="progress">
                            <div class="progress-bar bg-gradient-info w-{{ user.submission_count }}" role="progressbar" aria-valuenow="{{ user.submission_count }}" aria-valuemin="0" aria-valuemax="100"></div>
                          </div>
                        </div>
                      </td>
                    </tr>
